        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="md:flex">
            ...
            <div className="p-8 md:w-2/3">
              ...
              <p className="text-gray-700 mb-6">{equipment.desc}</p>
              
              {equipment.features && equipment.features.length > 0 && (
                <div className="mb-6">
                  <h2 className="text-xl font-semibold mb-2">功能特性</h2>
                  <p className="text-gray-600">{equipment.features.map(feature => feature.text).join(', ')}</p>
                </div>
              )}
              {equipment.models && equipment.models.length > 0 && (
                <div>
